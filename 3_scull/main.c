...
static void init_scull_dev(struct scull_dev *scull_dev)
{
	INIT_LIST_HEAD(&scull_dev->list);
	atomic_set(&scull_dev->list_entry_counter, 0);
	atomic_set(&scull_dev->open_counter, 0);
